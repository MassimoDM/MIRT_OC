...
def insight_50kw_power_jc():
    ...
    a20 =       1.867 +  0.01006;
    dFr1 = Prat/50e3*(a20*wn**2 + a02*Pn**2 + a11*wn*Pn + a10*wn + a01*Pn + a00);
    # 2
    a00 =      0.1662;
    ...
    a20 =           1;
    dFr2 = Prat/50e3*(a20*wn**2 + a02*Pn**2 + a11*wn*Pn + a10*wn + a01*Pn + a00);
    # 3
    a00 =    -0.04825;
    a01 =       2.274;
    a02 = 0;
    ...
    a11 =  0;
    a20 =   0;
    dFr3 = Prat/50e3*(a20*wn**2 + a02*Pn**2 + a11*wn*Pn + a10*wn + a01*Pn + a00);
    # 4
    a00 =  -2.507e-10;
    a01 =       1.589;
    a02 =           4  + 0.0246;
    ...
    a11 =          -1;
    a20 =        0.05 + 0.0246;
    dFr4 = Prat/50e3*(a20*wn**2 + a02*Pn**2 + a11*wn*Pn + a10*wn + a01*Pn + a00);
    # 5
    a00 =       -0.07;
    a01 =           6;
    a02 =           0;
    ...
    a11 =           0;
    a20 =           0;
    dFr5 = Prat/50e3*(a20*wn**2 + a02*Pn**2 + a11*wn*Pn + a10*wn + a01*Pn + a00);
    # result
    ...
    return {'dFin': cs.Function('dFin', [wrat,Prat,w,P],[dFr]),\
            ...
            'Pmax':  cs.Function('Tmax',[wrat,Prat,w],[Pmax]),\
